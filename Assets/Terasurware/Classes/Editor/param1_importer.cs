...
public class param1_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/Terasurware/ExcelData/param1.xlsx";
	private static readonly string exportPath = "Assets/Terasurware/ExcelData/param1.asset";
